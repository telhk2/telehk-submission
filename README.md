...
### Note: to request for the appsmith access as there is currently a known bug in appsmith that is being fixed.

![poster](https://github.com/telhk2/telehk-submission/blob/master/Telehack%20Product%20Brief.png)
...
## Google Data Studio
Google Data Studio is used in four main areas for reporting and visualisation purposes. The four areas are: 
1. Volunteer Management Dashboard for volunteers profiling, 
2. Event Management Dashboard for events details reporting (e.g. participation rate / number of events planned / event category summary), 
3. Volunteer Hours Report where a personalised volunteer event participation summary can be generated and 
...
- Project Demo Link
- Live working solution URL https://app.appsmith.com/applications/6210f8f06b4b1e154a3f1638/pages/6210f8f06b4b1e154a3f163b
